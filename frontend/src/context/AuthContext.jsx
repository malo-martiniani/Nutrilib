...
const TRANSLATIONS = {
  fr: {
    ...
    validation_email_format: "Veuillez saisir une adresse email valide.",
    ...
    validation_password_strong: 'Le mot de passe doit faire au moins 12 caractères et contenir une majuscule, une minuscule, un chiffre et un caractère spécial.',
    auth_email_hint: 'Format attendu: nom@domaine.fr',
    auth_password_hint: 'Au moins 12 caractères avec une majuscule, une minuscule, un chiffre et un caractère spécial.',
    ...
    auth_form_guidance_title: 'Consignes de sécurité',
    auth_form_guidance_text: 'Utilisez une adresse email valide et choisissez un mot de passe robuste d’au moins 12 caractères avec une majuscule, une minuscule, un chiffre et un caractère spécial. Évitez les mots de passe déjà utilisés ailleurs.',
    date: 'Date',
  ...
  en: {
    ...
    validation_password_strong: 'Password must be at least 12 characters and include one uppercase letter, one lowercase letter, one number, and one special character.',
    auth_email_hint: 'Expected format: name@domain.com',
    auth_password_hint: 'At least 12 characters with one uppercase letter, one lowercase letter, one number, and one special character.',
    sign_up_action: 'Sign up',
    sign_in_action: 'Sign in',
    create_account: 'Create account',
    no_account_yet: "Don't have an account? ",
    already_account_link: 'Already have an account? ',
    auth_form_guidance_title: 'Security guidelines',
    auth_form_guidance_text: 'Use a valid email address and choose a strong password of at least 12 characters with one uppercase letter, one lowercase letter, one number, and one special character. Avoid passwords you already use elsewhere.',
    date: 'Date',
