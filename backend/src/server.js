...
// Rate Limiter général pour les endpoints API (Protection DDoS)
const apiLimiter = rateLimit({
  windowMs: 1 * 60 * 1000, // 1 minute
  max: 120, // limite chaque IP à 120 requêtes par minute
...
app.use('/api/foods', apiLimiter, fatsecretRoutes);
...
app.use('/api/lists', apiLimiter, listsRoutes);
